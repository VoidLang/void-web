const Introduction = () => (
    <div>
        ...
        <a href="https://discord.com/invite/HdgnHqqGAW" target="_blank">Join the discord server</a>
        <h2>Want to help the project?</h2>
        <a href="https://paypal.me/voidlang" target="_blank">Donate to the Void Project</a>
    </div>
)
